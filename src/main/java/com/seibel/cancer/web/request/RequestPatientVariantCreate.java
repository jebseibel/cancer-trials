...
/**
 * Cross-entity references are extids, never numeric ids - the controller's converter resolves
 * them. Every status field is optional: an unanswered question is a first-class state here,
 * and requiring an answer would force a false negative.
 */
@Data
