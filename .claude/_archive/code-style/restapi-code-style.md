...
in the viro-server main module. Every feature area follows the same pattern:
...
**Location:** `src/main/java/com/viro/app/service/EnumService.java`
**Package:** `com.viro.app.service`
...
**Status:** Implemented. `EnumService` exists at `src/main/java/com/viro/app/service/EnumService.java`. `EnumController` delegates all logic to `EnumService`.
