...
- Enum: `common/src/main/java/com/viro/common/enums/ActiveEnum.java`
- Converter: `database/src/main/java/com/viro/database/converter/ActiveEnumConverter.java`
...
- `src/main/java/com/viro/app/web/controller/FacilityOutputController.java` — `toResponse()`, `create()`, `update()`
- `common/src/main/java/com/viro/common/enums/FacStatus.java` — `valueOf()`
...
Reference: `src/main/java/com/viro/app/web/controller/FacilityLoadController.java` — `toDisplayValue()` helper
